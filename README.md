...
> *Para detalhes técnicos de cada coluna e tipagem, consulte o arquivo `CATALOGO.md`.*
...
5.  **Limpeza de Tipos (`try_cast`):** Conversão segura de colunas numéricas (como *Average Mass* e *Clutch Size*) para evitar falhas de execução devido a caracteres sujos no Excel.
...
└── evidencias/               # Screenshots e gráficos gerados
    ├── 1_ingestao_sucesso.png
    ├── 2_modelo_delta.png
    ├── 3_grafico_familias.png
    └── ...
```
